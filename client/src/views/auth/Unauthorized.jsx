    ...
    <section className='my-32' id='unauthorized'>
      ...
      <div className="container-fluid mx-auto mt-6 grid justify-items-center">
        <button
          type="button"
          onClick={goBack}
          className="group relative flex w-32 rounded-md bg-pink-500 py-2 px-3 grid justify-items-center text-sm font-semibold text-white hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
        >
